...
//        }
    ...
    public void render() {
        if (!paused) {
            ...
            // PHASE 3: Physics debug rendering (hitbox, center of gravity, suspension points)
            ...
            // PHASE 4: Render the gear frame
            Gear gear = aircraft.getGear();
            shape.begin(ShapeRenderer.ShapeType.Filled);
            gear.renderFrame(shape);
            shape.end();
